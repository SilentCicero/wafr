...
contract PolarBoardRoomTests is Test {
  PolarMemberProxy member1;
  PolarMemberProxy member2;
  PolarMemberProxy member3;
  PolarMemberProxy member4;
  PolarMemberProxy member5;
  PolarMemberProxy member6;
  PolarMemberProxy destinationAccount;
  ...
  function setup(){
    member1 = new PolarMemberProxy();
    member2 = new PolarMemberProxy();
    member3 = new PolarMemberProxy();
    member4 = new PolarMemberProxy();
    member5 = new PolarMemberProxy();
    member6 = new PolarMemberProxy();
    destinationAccount = new PolarMemberProxy();
