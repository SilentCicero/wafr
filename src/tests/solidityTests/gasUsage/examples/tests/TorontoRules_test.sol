...
contract TorontoRulesBoardRoomTest is Test {
    ...
    TOMemberProxy member1;

    function setup() {
        member1 = new TOMemberProxy();
    ...
    function test_curatorDoesVeto() {
        ...
        address destinationAccount = address(new TOMemberProxy());

        TOMemberProxy member2 = new TOMemberProxy();
        registry.register(address(member2));
        TOMemberProxy member3 = new TOMemberProxy();
        registry.register(address(member3));
        TOMemberProxy member4 = new TOMemberProxy();
    ...
    function test_FiftySixPercent() {
        ...
        TOMemberProxy member4 = new TOMemberProxy();
        registry.register(address(member4));
        TOMemberProxy member5 = new TOMemberProxy();
        registry.register(address(member5));
        TOMemberProxy member6 = new TOMemberProxy();
        registry.register(address(member6));
        TOMemberProxy member7 = new TOMemberProxy();
        registry.register(address(member7));
        TOMemberProxy member8 = new TOMemberProxy();
        registry.register(address(member8));
        TOMemberProxy member9 = new TOMemberProxy();
