...
contract BondProxy is BondMemberProxy {
    function () payable public {}
...
contract BondRulesTest is Test {
  ...
  BoardRoom board;
  BondMemberProxy member1;
  BondProxy bondProxy;

  function setup() {
    member1 = new BondMemberProxy();
  ...
  function test_ShouldPassButNoBondSoFail() {
    ...
    address destinationAccount = address(new BondMemberProxy());
    BondMemberProxy member1 = new BondMemberProxy();
    registry.register(address(member1));
    BondMemberProxy member2 = new BondMemberProxy();
    registry.register(address(member2));
    BondMemberProxy member3 = new BondMemberProxy();
    registry.register(address(member3));
    BondMemberProxy member4 = new BondMemberProxy();
