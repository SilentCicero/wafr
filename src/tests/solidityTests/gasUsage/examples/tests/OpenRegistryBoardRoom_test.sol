...
contract OpenRegistryBoardRoomTest is Test {
  ...
  BoardRoom board;
  OpenMemberProxy member1;

  function setup() {
    member1 = new OpenMemberProxy();
  ...
  function test_newProposalAndVoting() {
    ...
    address destinationAccount = address(new OpenMemberProxy());
  ...
  function test_complexNewProposalAndVoting() {
    ...
    address destinationAccount = address(new OpenMemberProxy());
    OpenMemberProxy member1 = new OpenMemberProxy();
    registry.register(address(member1));
    OpenMemberProxy member2 = new OpenMemberProxy();
    registry.register(address(member2));
    OpenMemberProxy member3 = new OpenMemberProxy();
    registry.register(address(member3));
    OpenMemberProxy member4 = new OpenMemberProxy();
