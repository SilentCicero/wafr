...
contract CuratorRulesBoardRoomTest is Test {
    ...
    BoardRoom board;
    address [] curators;
    CuratorDeployUser duser;

    CuratorMemberProxy member1;

    function setup() {
        member1 = new CuratorMemberProxy();
        registry = new OpenRegistry();
        registry.register(address(member1));

        duser = new CuratorDeployUser();
    ...
    function test_curatorDoesVeto() {
        ...
        address destinationAccount = address(new CuratorMemberProxy());

        CuratorMemberProxy member2 = new CuratorMemberProxy();
        registry.register(address(member2));
        CuratorMemberProxy member3 = new CuratorMemberProxy();
        registry.register(address(member3));
        CuratorMemberProxy member4 = new CuratorMemberProxy();
