...
contract CampaignRulesTest is Test {
  ...
  function setup() {
    member1 = new CampaignMemberProxy();
  ...
  function test_campaignRules() {
    ...
    address destinationAccount = address(new CampaignMemberProxy());

    CampaignMemberProxy memberA = new CampaignMemberProxy();
    ...
    CampaignMemberProxy memberB = new CampaignMemberProxy();
    registry.register(address(memberB));
    CampaignMemberProxy memberC = new CampaignMemberProxy();
    registry.register(address(memberC));
    CampaignMemberProxy memberD = new CampaignMemberProxy();
