...
contract MultiSigRulesTest is Test {
  ...
  function test_ConsensysReached() {
    ...
    address destinationAccount = address(new MultisigMemberProxy());
    MultisigMemberProxy member1 = new MultisigMemberProxy();
    MultisigMemberProxy member2 = new MultisigMemberProxy();
    MultisigMemberProxy member3 = new MultisigMemberProxy();
    MultisigMemberProxy member4 = new MultisigMemberProxy();
