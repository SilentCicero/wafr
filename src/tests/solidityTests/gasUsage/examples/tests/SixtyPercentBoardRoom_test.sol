...
contract SixtyPercentBoardRoomTest is Test {
  ...
  BoardRoom board;
  SixtyMemberProxy member1;

  function setup() {
    member1 = new SixtyMemberProxy();
  ...
  function test_newProposalAndNotEnoughVotes() {
    ...
    address destinationAccount = address(new SixtyMemberProxy());
    SixtyMemberProxy member1 = new SixtyMemberProxy();
    registry.register(address(member1));
    SixtyMemberProxy member2 = new SixtyMemberProxy();
    registry.register(address(member2));
    SixtyMemberProxy member3 = new SixtyMemberProxy();
    registry.register(address(member3));
    SixtyMemberProxy member4 = new SixtyMemberProxy();
